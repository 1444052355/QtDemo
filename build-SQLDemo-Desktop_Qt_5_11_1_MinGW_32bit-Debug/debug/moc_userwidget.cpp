...
QT_MOC_LITERAL(3, 24, 12), // "UpdateSignal"
QT_MOC_LITERAL(4, 37, 10), // "returnSlot"
QT_MOC_LITERAL(5, 48, 9), // "StartSlot"
QT_MOC_LITERAL(6, 58, 10) // "updateSlot"

    },
    "UserWidget\0StartSignal\0\0UpdateSignal\0"
    "returnSlot\0StartSlot\0updateSlot"
};
...
void UserWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->StartSignal((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->UpdateSignal(); break;
        case 2: _t->returnSlot(); break;
        case 3: _t->StartSlot((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (UserWidget::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserWidget::StartSignal)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserWidget::UpdateSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void UserWidget::StartSignal(QString _t1)
{
